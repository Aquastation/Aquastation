...
/* CREATE DATABASE IF NOT EXISTS `paradise_gamedb` /*!40100 DEFAULT CHARACTER SET utf8 */ /* - AQUASTATION EDIT ORIGINAL */;
/* USE `paradise_gamedb`; - AQUASTATION EDIT ORIGINAL */;
CREATE DATABASE IF NOT EXISTS `aqua_gamedb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `aqua_gamedb`;
